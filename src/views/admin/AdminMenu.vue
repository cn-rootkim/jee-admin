<template>
  <el-main>
            ...
            >
              <template #default="{ node, data }">
                <span class="custom-tree-node">
                  ...
                  <span>
                    <el-button style="margin-left: 8px;" @click="onUpdateMenu(data)" size="small" :disabled="onUpdateMenuDisabled">修改菜单</el-button>
                  </span>
                </span>
              </template>
            </el-tree>
    ...
    <el-dialog v-model="dialogAddMenuVisible" title="新增菜单" width="500" destroy-on-close :close-on-click-modal="false">
    ...
    <el-dialog v-model="dialogUpdateMenuVisible" title="修改菜单" width="500" destroy-on-close :close-on-click-modal="false">
      <el-form :model="updateMenuFormData" style="margin-left: 60px" :rules="updateMenuRules" ref="updateMenuRuleFormRef">
    ...
    <el-dialog v-model="dialogAddFunctionVisible" title="新增功能" width="500" destroy-on-close :close-on-click-modal="false">
      <el-form :model="addFunctionFormData" style="margin-left: 60px" :rules="addFunctionRules" ref="addFunctionRuleFormRef">
    ...
    <el-dialog v-model="dialogUpdateFunctionVisible" title="修改功能" width="500" destroy-on-close :close-on-click-modal="false">
      <el-form :model="updateFunctionFormData" style="margin-left: 60px" :rules="updateFunctionRules" ref="updateFunctionRuleFormRef">
...
const fetchAdminMenuFunctionData = async () => {
  const adminMenuFunction = await adminMenuFunctionApi.list({"adminMenuId":checkedAdminMenu.value.id});
